              ...
              <div class="item-content">
                ...
                <div class="item-inner">
                  ...
                  <f7-grid>
                    ...
                    <f7-col>
                      <input name="first_name" autocomplete="off" v-validate="'required|alpha_num|min:2|max:20'" v-model="user.first_name" type="text" :placeholder="$app.trans('first_name')">
                    </f7-col>

                    <f7-col>
                      <input name="last_name" autocomplete="off" v-validate="'required|alpha_num|min:2|max:20'" v-model="user.last_name" type="text" :placeholder="$app.trans('last_name')">
                    </f7-col>
              ...
              <div class="item-content">
                ...
                <div class="item-inner">
                  ...
                  <div class="item-input">
                    <input name="email" autocomplete="off" v-validate="'required|email'" v-model="user.email" type="text" :placeholder="$app.trans('email')">
                  </div>
                </div>
              </div>
            </li>
            ...
            <li>
              <div class="item-content">
                ...
                <div class="item-inner">
                  ...
                  <div class="item-input">
                    <input name="password" autocomplete="off" v-validate="'required|min:10'" v-model="user.password" type="password" :placeholder="$app.trans('password')">
                  </div>
                </div>
              </div>
            </li>
            ...
            <li>
              <div class="item-content">
                ...
                <div class="item-inner">
                  ...
                  <div class="item-input">
                    <input name="repassword" autocomplete="off" v-validate="'required|confirmed:password|min:10'" v-model="user.repassword" type="password" :placeholder="$app.trans('confirm_password')">
                  </div>
                </div>
              </div>
            </li>
